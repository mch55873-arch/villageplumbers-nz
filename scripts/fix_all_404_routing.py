...
print("=== FIXING ALL 404 ROUTING BUGS FOR MAIN DOMAIN AND SUBDOMAINS ===")
...
with open("src/worker.ts", "w", encoding="utf-8") as f:
  f.write(worker_code)
print("[OK] Updated src/worker.ts with robust non-404 routing for main domain and all subdomains")
