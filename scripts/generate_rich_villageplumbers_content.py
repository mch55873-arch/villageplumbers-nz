...
print("=== FIXING ESCAPED QUOTES IN RICH VILLAGE PLUMBERS CONTENT GENERATOR ===")
...
export function singleArticlePage(article: any) {
  ...
  const summary = article.summary || "Expert plumbing advice from PGDB certificated master plumbers.";
  ...
  <section class="page-hero">
    <div class="wrap">
      ...
      <p style="color:#cbd5e1;font-size:16px;margin-top:12px;">By Certified Master Arborist &amp; Master Plumber Editorial Team · Updated 2026</p>
    </div>
  </section>
  ...
  <section class="sec-white" style="padding:70px 0;">
    <div class="wrap service-main-grid">
      <div class="service-content-box">
        <h2>${esc(title)}</h2>
        <p>${esc(summary)}</p>
        <p>In New Zealand, maintaining property plumbing, gas lines, and drainage systems is critical to prevent costly structural water damage and health hazards. This comprehensive guide outlines best practices, warning signs, and professional inspection steps recommended by PGDB master plumbers.</p>

        <h2>Key Warning Signs You Shouldn't Ignore</h2>
        <ul>
          <li>Unexplained drops in hot water pressure or discolored water from taps</li>
          <li>Gurgling sounds in toilets or slow-draining shower gullies</li>
          <li>Damp patches or mold growth along internal skirting boards</li>
          <li>Sudden increase in monthly water authority utility bills</li>
        </ul>

        <h2>When to Call a PGDB Master Plumber</h2>
        <p>If you observe any of the above warning signs, immediate diagnostic inspection can save thousands in emergency water restoration costs. Our 24/7 referral network provides same-day dispatch across all New Zealand regions.</p>

        <div style="margin-top:28px;padding:24px;background:#f0f9ff;border-left:4px solid #0ea5e9;border-radius:12px;">
          <h3 style="margin:0 0 8px;color:#0d1b2a;">Need Immediate Emergency Assistance?</h3>
          <p style="margin:0 0 16px;color:#475569;">Our 24/7 NZ dispatch team is standing by to connect you with licensed local master plumbers.</p>
...
print("[OK] Re-generated clean locationTemplates.ts without syntax errors")
